...
export function LoginPage({ initialMode = 'signin' }: LoginPageProps) {
  ...
  return (
    <div className="login-page-bg min-h-screen w-full bg-gradient-to-br from-[#061536] via-[#030C22] to-[#020817] relative overflow-hidden flex flex-col font-['Inter',sans-serif] select-none transition-colors duration-300">
      ...
      <div className="login-ambient-orb absolute top-[25%] right-[8%] w-[500px] h-[500px] bg-[#3B82F6]/14 rounded-full blur-[140px] pointer-events-none z-0 transition-opacity duration-300" />
      <div className="login-ambient-orb absolute bottom-[5%] left-[22%] w-[450px] h-[450px] bg-[#4E55F5]/12 rounded-full blur-[130px] pointer-events-none z-0 transition-opacity duration-300" />
