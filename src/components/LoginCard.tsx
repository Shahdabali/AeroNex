...
export function LoginCard({ initialMode = 'signin' }: LoginCardProps) {
  ...
  const [email, setEmail] = useState(() => {
    return localStorage.getItem('aeronex_remembered_email') || '';
  });
        ...
        <div className="mb-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
            <button
              ...
              className="login-social-btn h-[44px] rounded-2xl bg-[#040C20]/95 hover:bg-[#091C44] border border-blue-500/30 hover:border-cyan-400/60 text-white text-xs font-semibold flex items-center justify-center gap-2.5 transition-all cursor-pointer shadow-md hover:shadow-[0_0_20px_rgba(0,163,255,0.25)] group disabled:opacity-60"
            >
